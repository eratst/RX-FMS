 ...
 */
@Entity
@Table(name = "T_PM_WAREHOUSETECHNIC")
public class WarehousTechnic implements Serializable {
	private static final long serialVersionUID = 1L;
	@Id
	@Column(name="WAREHOUSETECHNIC_ID")
	private Long technicId;
	
	@Column(name="WAREHOUSETECHNIC_CODE")
	private String technicCode;
	
	@Column(name="WAREHOUSETECHNIC_NAME")
