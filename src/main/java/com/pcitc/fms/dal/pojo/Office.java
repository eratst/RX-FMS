...
@Entity
@Table(name = "T_PM_OFFICE")
public class Office implements INodeAndArea, Serializable {
	...
	@SpecialResource(name="org.orgTypeCode")
	@Transient
	 ...
	 * @param des
	 */
	public Office(Long orgId, String orgCode, String orgName, String orgAlias, Long orgTypeId, String orgTypeCode,
			String orgTypeName, Integer inUse, String crtUserCode, String crtUserName, Date crtDate, String mntUserCode,
			String mntUserName, Date mntDate, String des, Integer sortNum,String orgLatitude,String orgAltitude,String orgLongitude) {
		super();
		this.orgId = orgId;
