...
@Entity
@Table(name = "T_PM_DEPARTMENT")
public class Department implements INodeAndArea, Serializable {
	 ...
	 * @param des
	 */
	public Department(Long orgId, String orgCode, String orgName, String orgAlias, Long orgTypeId,
			String orgTypeCode, String orgTypeName, Integer inUse, String crtUserCode, String crtUserName, Date crtDate,
			String mntUserCode, String mntUserName, Date mntDate, String des, Integer sortNum,String orgLatitude,String orgAltitude,String orgLongitude) {
		super();
		this.orgId = orgId;
