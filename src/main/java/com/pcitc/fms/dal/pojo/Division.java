...
@Entity
@Table(name = "T_PM_DIVISION")
public class Division implements INodeAndArea, Serializable {
	 ...
	 * @param des
	 */
	public Division(Long orgId, String orgCode, String orgName, String orgAlias, Long orgTypeId,
