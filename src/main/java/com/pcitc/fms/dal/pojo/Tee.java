...
public class Tee implements Serializable {
	...
	public Tee(Long nodeId, String nodeCode, String crtUserCode,
			String crtUserName, Date crtDate, String mntUserCode,
			String mntUserName, Date mntDate, String des, Long areaId,String areaCode,
			String nodeLongitude, String nodeLatitude, Long nodeTypeId,
			Integer inUse, String nodeAltitude, String nodeName,
			String nodeAlias, String nodeTypeName,String areaName,String areaAlias,Integer sortNum) {
		super();
		this.nodeId = nodeId;
