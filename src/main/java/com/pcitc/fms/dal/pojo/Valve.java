...
/**
 * Title: ValvePojo Description:2.10 阀门（Valve）及其集合（Valves）
 *
...
public class Valve implements Serializable {
    ...
    public Valve(Long nodeId, String nodeCode, String crtUserCode,
                 ...
                 String nodeAlias, String nodeTypeName, Integer sortNum,
                 String areaCode, String areaName, String areaAlias, String nodeLevel, String nodeModel) {
        super();
        this.nodeId = nodeId;
