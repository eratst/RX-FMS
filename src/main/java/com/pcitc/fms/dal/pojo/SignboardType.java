 ...
 */
@Entity
@Table(name = "T_PM_SIGNBOARDTYPE")
public class SignboardType implements Serializable {
	private static final long serialVersionUID = 1L;
	@Id
	@Column(name="SIGNBOARDTYPE_ID")
	private Long signboardTypeId;
	
	@Column(name="SIGNBOARDTYPE_CODE")
	private String signboardTypeCode;
	
	@Column(name="SIGNBOARDTYPE_NAME")
	...
	public Long getSignboardTypeId() {
		return signboardTypeId;
	}
	public void setSignboardTypeId(Long signboardTypeId) {
