...
public class ProduceFactory implements INodeAndArea, Serializable {
	...
	@SpecialResource(name="fctrBlockType.fctrBlockId")
	@Column(name = "FCTRBLOCKTYPE_ID")
	private Long fctrBlockId;

	@SpecialResource(name="fctrBlockType.fctrBlockTypeCode")
	@Transient
	private String fctrBlockCode;

	@SpecialResource(name="fctrBlockType.fctrBlockTypeName")
	@Transient
	private String fctrBlockName;

	@SpecialResource(name="t.businessTypeId")
	 ...
	 * @param des
	 */
	public ProduceFactory(Long orgId, String orgCode, String orgName, String orgAlias, Long orgTypeId,
			String orgTypeCode, String orgTypeName, String fctrBlockCode, String fctrBlockName, Long businessTypeId,
			Integer inUse, String crtUserCode, String crtUserName, Date crtDate, String mntUserCode, String mntUserName,
			Date mntDate, String des, Integer sortNum,String orgLatitude,String orgAltitude,String orgLongitude) {
		super();
		this.orgId = orgId;
