...
public interface ManagementTankDao extends JpaRepository<ManagementTank, Integer>, JpaSpecificationExecutor<ManagementTank> {
	@Transactional
	public Page<ManagementTank> findManagementTanks(com.pcitc.fms.service.model.ManagementTank managementTank, Pageable pageable);
