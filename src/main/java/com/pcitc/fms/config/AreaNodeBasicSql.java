...
public  interface AreaNodeBasicSql {
	...
	//采样点
//	static final String samplePoint = "select new SamplePoint(a.nodeId,a.nodeCode,b.nodeName,b.nodeAlias,e.areaDictionaryId,e.areaCode,e.name,e.shortName,a.samplepointTypeId,d.samplepointTypeCode,d.samplepointTypeName,b.nodeLongitude,b.nodeLatitude,b.nodeAltitude,a.crtUserId,a.crtUserName,a.crtDate,a.mntUserId,a.mntUserName,a.mntDate,b.dataStatus,a.sortNum,b.des) from SamplePoint a,NodeDictionary b,NodeType c,SamplepointType d,AreaDictionary e  where "
//							        + " a.nodeCode = b.nodeCode and b.nodeTypeId = c.nodeTypeId and a.samplepointTypeId = d.samplepointTypeId and b.areaId = e.areaDictionaryId ";
