...
public class ProduceFactory extends BaseResRep implements Serializable {
	...
	@ResourceMember(InQueries = "condition", Name = "orgTypeId")
	...
	@CheckField(CheckName = CheckNameType.CODE)
	@ResourceMember(InQueries = "condition", Name = "fctrBlockCode")
	private String fctrBlockCode;

	@CheckField(CheckName = CheckNameType.NAME)
	@ResourceMember(Name = "fctrBlockName")
	...
	@CheckField(CheckName = CheckNameType.CODE)
	@ResourceMember(InQueries = "condition", Name = "businessTypeCode")
	private String businessTypeCode;

	@CheckField(CheckName = CheckNameType.NAME)
	@ResourceMember(Name = "businessTypeName")
