...
public class Enterprise extends BaseResRep implements Serializable {
	...
	@CheckField(CheckName = CheckNameType.CODE)
	@ResourceMember(InQueries = "condition", Name = "entrTypeCode")
	private String entrTypeCode;

	@CheckField(CheckName = CheckNameType.NAME)
	@ResourceMember(Name = "entrTypeName")
