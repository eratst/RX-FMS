...
public class Community extends BaseResRep implements Serializable{
	...
	@BuildLink(resourceCode = "communityCode")
	private String communityCode;
	//区域名称
	@CheckField(CheckName = CheckNameType.NAME ,StrLength=50)
	@ResourceMember(InQueries="condition",Name="communityName")
	...
	//区域简称
	@CheckField(CheckName = CheckNameType.NAME ,StrLength=50)
	@ResourceMember(InQueries="condition",Name="communityAlias")
