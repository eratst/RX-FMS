...
public class PipeNetwork extends BaseResRep implements Serializable {
...
@BuildLink(resourceCode = "pipeNetworkCode")
private String pipeNetworkCode;
//区域名称
@CheckField(CheckName = CheckNameType.NAME ,StrLength=50)
@ResourceMember(InQueries="condition",Name="pipeNetworkName")
...
//区域简称
@CheckField(CheckName = CheckNameType.NAME ,StrLength=50)
@ResourceMember(InQueries="condition",Name="pipeNetworkAlias")
...
//排序
@CheckField(CheckName = CheckNameType.ID ,StrLength=30)
