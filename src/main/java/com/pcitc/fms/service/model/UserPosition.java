...
public class UserPosition extends BaseResRep implements Serializable {
	...
	@CheckField(CheckName = CheckNameType.CODE, StrLength = 36)
	@ResourceMember(InQueries = "condition", Name = "orgCode",OnlyQuery = true)
	private String rentCode;
	
	@CheckField(CheckName = CheckNameType.CODE, StrLength = 36)
	@ResourceMember(InQueries = "condition", Name = "bizCode",OnlyQuery = true)
	...
	@CheckField(CheckName = CheckNameType.CODELIST, StrLength = 100)
	@ResourceMember(InTemplate = false, InQueries = "search", OnlyQuery = true, Name = "$userCodes")
