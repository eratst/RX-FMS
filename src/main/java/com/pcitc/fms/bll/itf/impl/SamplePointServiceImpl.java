...
public class SamplePointServiceImpl implements SamplePointService {
	 ...
	 * The constant log.
	 */
	private static Logger log = LoggerFactory.getLogger(SamplePointServiceImpl.class);
	/**
	 * The Sample point dao.
	 */
	@Autowired
	...
	/**
	 * Gets page sample points.
	 *
	 * @param samplePointModel the sample point model
	 * @param pageable the pageable
	 * @param areaCode the area code
	 * @return the page sample points
	 * @throws BusinessException the business exception
	 */
	@Override
	@Transactional(rollbackFor = BusinessException.class)
	public Pager<com.pcitc.fms.bll.entity.SamplePoint> getPageSamplePoints(com.pcitc.fms.service.model.SamplePoint samplePointModel, Pageable pageable)
			throws BusinessException {
		MyPageImpl properties = null;
		try {
			properties = samplePointDao.findPageSamplePoints(samplePointModel, pageable);;
		} catch (Exception e) {
			if (e instanceof UndeclaredThrowableException) {
				throw new BusinessException("", e.getCause().getMessage());
			}
		}
		List<SamplePoint> propertiesEntity = null;
		try {
			propertiesEntity = ObjectConverter.listConverter(properties.getContent(), SamplePoint.class);
		} catch (Exception e) {
			log.error("fail",e);
			throw  new BusinessException("","",e.getMessage());
		}
		Pager<com.pcitc.fms.bll.entity.SamplePoint> pageData = new Pager<>();
